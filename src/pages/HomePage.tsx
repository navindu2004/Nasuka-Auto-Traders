          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Explore our curated selection of quality vehicles from Japan's leading auctions and dealers
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Submit your order with shipping details. We'll confirm and begin the purchase process
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Monitor your order status in real-time from purchase to delivery at your doorstep
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                All cars are inspected and verified from trusted Japanese sources
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Clear breakdown of costs including car price, fees, and shipping
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Quick order confirmation and efficient purchase workflow
              </p>
            </div>
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Start browsing our inventory of quality Japanese vehicles today
          </p>
          <Link
            to="/cars"
